      ...
      <div className="flex h-14 items-center gap-3 px-4">
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="relative w-115 max-w-115">
            ...
            <Input
              placeholder="Search"
              className="h-9 rounded-full pl-10 pr-30 bg-neutral-50 border-neutral-200 focus-visible:ring-0 focus-visible:ring-offset-0"
            />
            
            {/* Ask AI */}
            <div className="absolute right-2 top-1/2 -translate-y-1/2">
              <Button className="h-7 rounded-full bg-brand hover:bg-brand-hover px-3 text-xs text-brand-foreground shadow-sm">
